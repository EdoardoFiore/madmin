...
export async function render(container, params) {
    ...
    const activeTab = (params && params[0] === 'access-lists') ? 'access-lists' : 'hosts';
        ...
        <div class="card">
            ...
            <div class="tab-content">
                <div class="tab-pane fade ${activeTab === 'hosts' ? 'show active' : ''}" id="revproxy-pane-hosts">
                    <div class="card-body" id="revproxy-hosts-body">${loadingSpinner()}</div>
                </div>
                <div class="tab-pane fade ${activeTab === 'access-lists' ? 'show active' : ''}" id="revproxy-pane-acls">
                    <div class="card-body" id="revproxy-acls-body">${loadingSpinner()}</div>
                </div>
            </div>
        </div>
    `;
